...
async def show_products(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text("اختر منتج:", reply_markup=InlineKeyboardMarkup(keyboard))
...
async def orders(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text(text if text.strip() != "📋 طلباتك:" else "لا يوجد")
